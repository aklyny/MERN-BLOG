...
export default () => (
  <div>
    ...
    <div className="jumbotron bg-danger">
      <h1 className="display-3">Sri Bharathi Dass Ak<span className="h4">  (Full Stack Devloper)</span></h1>
      ...
      <p><Link className="btn btn-primary btn-lg" to="/posts" role="button">Let's get Started &raquo;</Link></p>
    </div>
